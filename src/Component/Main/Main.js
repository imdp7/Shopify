      ...
      >
        ...
        >
          ...
          <SubMenu key="Orders" icon={<LaptopOutlined style={size}/>} title="Orders">
            <Menu.Item key="5"><Link to='/Orders'> Open </Link></Menu.Item>
            <Menu.Item key="6">Draft</Menu.Item>
            <Menu.Item key="7">Abandon Checkout</Menu.Item>
          </SubMenu>
          <SubMenu key="Products" icon={<TagsOutlined style={size}/>} title="Products">
          
            <Menu.Item key="9">
            <Link to='/AllProducts' replace>All Products</Link></Menu.Item>
            <Menu.Item key="10">Inventory</Menu.Item>
            <Menu.Item key="11">Transfers</Menu.Item>
            <Menu.Item key="12">Collections</Menu.Item>
            <Menu.Item key="13">Gift Cards</Menu.Item>
